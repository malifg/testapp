...
int RS232Test::initialize()
{
    char *ttyName = PORT_RS232;
...
void RS232Test::run()
{
    ...
    while (testStart == true)
    {
        if(isTester == true)
        {
            Logger::LOG(__FILE__, __FUNCTION__, __LINE__, LOG_TYPE::DEBUG, "RS232 Tester");
        }
        else
        {
            Logger::LOG(__FILE__, __FUNCTION__, __LINE__, LOG_TYPE::DEBUG, "RS232 receiver");
